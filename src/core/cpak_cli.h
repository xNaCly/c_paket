...
#define U_HELP "Help displays basic info and a reference about each available command.\n\n\
\thelp [command]\n\th [command]\n\nExample:\n\tcpak h help\n\tcpak h\n"

#define U_INIT "Init initialises a new cpak project and creates a 'cpak_project.conf'.\n\n\
\tinit <dir>\n\ti <dir>\n\nExample:\n\tcpak i .\n"

#define U_ADD "Add adds a new package to the project.\n\n\
\tadd <package>\n\ta <package>\n\nExample:\n\tcpak a xnacly/xc\n"

#define U_REMOVE "Remove removes a package from the project.\n\n\
\tremove <package>\n\tr <package>\n\nExample:\n\tcpak r xnacly/xc\n"

#define U_BOOTSTRAP "Bootstrap bootstraps a new directory from a predefined template.\n\n\
\tbootstrap <template>\n\tb <template>\n\nExample:\n\tcpak b default\n"
